...
export function ShareButtons({ title, description, url, image }: ShareButtonsProps) {
  ...
  const encodedImage = fullImageUrl ? encodeURIComponent(fullImageUrl) : ''
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-lg animate-fade-in">
